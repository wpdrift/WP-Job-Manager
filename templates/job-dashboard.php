											...
											switch ( $job->post_status ) {
												case 'publish' :
													...
													if ( is_position_filled( $job ) ) {
														$actions['mark_not_filled'] = array( 'label' => __( 'Mark not filled', 'wp-restaurant-listings' ), 'nonce' => true );
													} else {
														$actions['mark_filled'] = array( 'label' => __( 'Mark filled', 'wp-restaurant-listings' ), 'nonce' => true );
													}
												...
												case 'expired' :
													if ( job_manager_get_permalink( 'submit_job_form' ) ) {
														$actions['relist'] = array( 'label' => __( 'Relist', 'wp-restaurant-listings' ), 'nonce' => true );
													}
													break;
