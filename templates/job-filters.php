	...
	<div class="search_jobs">
		...
		<?php elseif ( $show_categories && ! is_tax( 'restaurant_listing_category' ) && get_terms( 'restaurant_listing_category' ) ) : ?>
			<div class="search_categories">
				...
				<?php else : ?>
					<?php job_manager_dropdown_categories( array( 'taxonomy' => 'restaurant_listing_category', 'hierarchical' => 1, 'show_option_all' => __( 'Any category', 'wp-job-manager' ), 'name' => 'search_categories', 'orderby' => 'name', 'selected' => $selected_category, 'multiple' => false ) ); ?>
				<?php endif; ?>
			</div>
		<?php endif; ?>
