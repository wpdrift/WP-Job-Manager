...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<div class="search_keywords">
			...
			<input type="text" name="search_keywords" id="search_keywords" placeholder="<?php esc_attr_e( 'Keywords', 'wp-restaurant-listings' ); ?>" value="<?php echo esc_attr( $keywords ); ?>" />
		</div>
		...
		<?php elseif ( $show_categories && ! is_tax( 'restaurant_listing_category' ) && get_terms( 'restaurant_listing_category' ) ) : ?>
			<div class="search_categories">
				...
				<?php if ( $show_category_multiselect ) : ?>
					<?php job_manager_dropdown_categories( array( 'taxonomy' => 'restaurant_listing_category', 'hierarchical' => 1, 'name' => 'search_categories', 'orderby' => 'name', 'selected' => $selected_category, 'hide_empty' => false ) ); ?>
				<?php else : ?>
					<?php job_manager_dropdown_categories( array( 'taxonomy' => 'restaurant_listing_category', 'hierarchical' => 1, 'show_option_all' => __( 'Any category', 'wp-restaurant-listings' ), 'name' => 'search_categories', 'orderby' => 'name', 'selected' => $selected_category, 'multiple' => false ) ); ?>
				<?php endif; ?>
			</div>
		<?php endif; ?>
